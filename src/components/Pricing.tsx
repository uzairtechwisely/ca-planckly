...
export function Pricing({
  ...
  const resolvedEyebrow = eyebrow ?? "PRICING";
  const resolvedHeading = heading ?? "Simple plans in USD";
  const resolvedDescription =
    description ??
    "A California launch experience with pricing shown in USD. We’ll refine packages as we iterate on the visuals and messaging.";
  const resolvedPlans =
    plans ?? [
      {
        name: "Free",
